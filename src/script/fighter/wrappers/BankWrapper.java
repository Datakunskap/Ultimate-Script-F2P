...
public class BankWrapper {
    ...
    private static int gpGained;

    public static int getAmountGoldGained() { return gpGained; }

    public static void setAmountGoldGained(int gpGained) { BankWrapper.gpGained = gpGained; }
    ...
    public static void withdrawSellableItems() {
        ...
        Item[] sellables = Bank.getItems(i -> i.isExchangeable() && !TradePlayer.isTradeRestrictedItem(i.getName()));
