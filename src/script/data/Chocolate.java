...
public class Chocolate {
    ...
    public int maxKeep = 250000;
    // Max amount to keep from mule
    public int minKeep = 125000;
    // Mules in-game name
    public static final String MULE_NAME = "drscatman";
    // GE area to mule
    public static final MuleArea muleArea = MuleArea.COOKS_GUILD;
    // Mules World
